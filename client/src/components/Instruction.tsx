    ...
    return (
        <div className='max-w-7xl mx-auto px-10 lg:px-0'>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3'>
                <div>
                    <img className='mx-auto' src="https://d19qjkjk65tfln.cloudfront.net/v2/assets/img/home/search.svg" alt="" />
                ...
                <div>
                    <img className='mx-auto' src="https://d19qjkjk65tfln.cloudfront.net/v2/assets/img/home/select.svg" alt="" />
                ...
                <div>
                    <img className='mx-auto' src="https://d19qjkjk65tfln.cloudfront.net/v2/assets/img/home/pay.svg" alt="" />
